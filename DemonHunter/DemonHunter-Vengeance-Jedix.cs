...
namespace PixelMagic.Rotation
{
    public class DemonHunterVeng : CombatRoutine
    {
        ...
        public override void Initialize()
        {
			...
			Log.Write("Also need to do a macro in wow to make Sigil of Flame work, macro #showtooltip /cast [mod:shift,target=player][nomod,target=player][mod:ctrl,target=player] Sigil of Flame /cast [mod:alt] Sigil of Flame /script UIErrorsFrame:Clear()", Color.Black);
