...
namespace PixelMagic.Rotation
{
    ...
    {
		public override string Name { get { return "BM Hunter by Vectarius - I am back!"; } }
        ...
        public override void Pulse()
        {
            if (combatRoutine.Type == RotationType.SingleTarget)  // Do Single Target Stuff here
            {
                ...
                {	
                    ...
                    if (WoW.TargetIsCasting && CounterShot)
                    {
                        if (WoW.CanCast("Counter Shot") && WoW.TargetPercentCast > 20 && !WoW.IsSpellOnCooldown("Counter Shot") && CounterShot && !WoW.PlayerIsChanneling && !WoW.WasLastCasted("Counter Shot"))
                        {
					...
					if (WoW.CanCast("Aspect of the Wild") && !WoW.IsSpellOnCooldown("Aspect of the Wild")  && WoW.PlayerHasBuff("Bestial Wrath") && WoW.PlayerBuffTimeRemaining("Bestial Wrath") >= 10 && dpscooldowns ) 
                    {
					...
					//{
						...
						//return;
					//}
					if (WoW.CanCast("Kill Command") && WoW.IsSpellInRange("Kill Command"))
                    {
