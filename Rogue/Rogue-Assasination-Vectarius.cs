    ...
    public class Assassination : CombatRoutine
    {
        ...
        public override void Pulse()
        {
                ...
                if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat) {
                    if (
                        ...
                        (
                            ...
                            WoW.TargetHasDebuff("Rupture") &&
                            WoW.TargetDebuffTimeRemaining("Rupture") < 5
                        )
                    ) {
                    ...
                    if (
                        WoW.CanCast("Envenom") &&
                        WoW.Energy >= 35 &&
                        !WoW.PlayerHasBuff("Envenom") &&
                        WoW.CurrentComboPoints >= 3 &&
                        WoW.TargetHasDebuff("Rupture") &&
                        WoW.TargetDebuffTimeRemaining("Rupture") >= 10 &&
                        (
                            !WoW.PlayerHasBuff("Elaborate Planning") ||
                            WoW.PlayerBuffTimeRemaining("Elaborate Planning") <= 2.0
                        )
                    ) {
                    ...
                    if (
                        WoW.CanCast("Mutilate") &&
                        WoW.Energy >= 55 &&
                        WoW.CurrentComboPoints <= 5 &&
                        WoW.PlayerBuffTimeRemaining("Elaborate Planning") >= 2.1
                        ) {
            ...
            if (combatRoutine.Type == RotationType.AOE || combatRoutine.Type == RotationType.SingleTargetCleave) // Do AoE Target Stuff here
            {
                ...
                if (
                    WoW.CanCast("Fan of Knives") &&
                    WoW.Energy >= 35 &&
                    !WoW.TargetHasDebuff("Agonizing Poison")
                    ) {
                ...
                if (
                    ...
                    WoW.Energy >= 35 &&
                    WoW.TargetHasDebuff("Agonizing Poison") &&
                    WoW.TargetDebuffStacks("Agonizing Poison") <= 4
                    ) {
                    WoW.CastSpell("Fan of Knives");
                    return;
                }
                if (
                    ...
                    WoW.Energy >= 35 &&
                    WoW.TargetHasDebuff("Agonizing Poison") &&
                    WoW.TargetDebuffTimeRemaining("Agonizing Poison") < 2
                    ) {
                    WoW.CastSpell("Fan of Knives");
                    return;
                }
