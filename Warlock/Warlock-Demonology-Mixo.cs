...
namespace PixelMagic.Rotation
{
    public class DemonologyWarlockMixo : CombatRoutine
    {
        ...
        private Stopwatch DreadstalkersTime = new Stopwatch();
		private Stopwatch ImpTime = new Stopwatch();
        ...
        private static float OneFiveCast = Convert.ToSingle(1.5f / (1 + (WoW.HastePercent / 100f)));
        private static float TwoSecondCast = Convert.ToSingle(2f / (1 + (WoW.HastePercent / 100f)));
		private static float SBExecuteTime = Math.Max(TwoSecondCast,gcd);
		...
		private string readme = "Mixo's Demonology Rotation v0.1 (beta)" + Environment.NewLine +
	"";
        ...
        public override void Initialize()
        {
            ...
            Log.Write("-----", Color.DarkViolet);
            WoW.Speak("Mix Oh! Demon Ology!");
            
            SettingsForm = new Form
            {
                Text = "Mixo's Demo Warlock Rotation - Settings",
        ...
        public override void Pulse()
        {
			...
			float DreadstalkersRemainingDuration = Convert.ToSingle((12000f - DreadstalkersTime.ElapsedMilliseconds) / 1000f);
			float ImpsRemainingDuration = Convert.ToSingle((12000f - ImpTime.ElapsedMilliseconds) / 1000f + OneFiveCast);
            ...
            if (combatRoutine.Type == RotationType.SingleTarget)
            {
                ...
                if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat && !WoW.PlayerIsCasting)
                {
					...
					if(WoW.CanCast("Shadowflame") && Shadowflame && WoW.IsSpellInRange("Doom") && WoW.TargetHasDebuff("Shadowflame") && WoW.TargetDebuffTimeRemaining("Shadowflame") < TwoSecondCast + 2)
					{
					...
					if(WoW.CanCast("CallDreadstalkers") && !SummonDarkglare && (WoW.CurrentSoulShards >= 2 || WoW.PlayerHasBuff("DemonicCalling")) && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
					...
					if(WoW.CanCast("HandOfGuldan") && !SummonDarkglare && WoW.LastSpell != ("HandOfGuldan") && WoW.CurrentSoulShards >= 4 && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
					...
					if(WoW.CanCast("SummonDarkglare") && SummonDarkglare && WoW.CurrentSoulShards >= 1 && WoW.TargetHasDebuff("Doom") && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
                    ...
                    //Hand Of Guldan
					if(WoW.CanCast("HandOfGuldan") && WoW.LastSpell != ("HandOfGuldan") && WoW.CurrentSoulShards >= 3 && WoW.LastSpell == ("CallDreadstalkers") && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
						WoW.CastSpell("HandOfGuldan");
						empowered = false;
						threeimps = true;
					...
					if(WoW.CanCast("HandOfGuldan") && SummonDarkglare && WoW.LastSpell != ("HandOfGuldan") && WoW.CurrentSoulShards >= 5 && WoW.SpellCooldownTimeRemaining("SummonDarkglare") <= OneFiveCast && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
						WoW.CastSpell("HandOfGuldan");
						threeimps = false;
						empowered = false;
                    ...
                    //Hand Of Guldan (if talent Summon Darkglare)
					if(WoW.CanCast("HandOfGuldan") && SummonDarkglare && WoW.LastSpell != ("HandOfGuldan") && WoW.CurrentSoulShards >= 4 && WoW.SpellCooldownTimeRemaining("SummonDarkglare") > 2 && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
						WoW.CastSpell("HandOfGuldan");
						threeimps = false;
						empowered = false;
					...
					if(WoW.CanCast("DemonicEmpowerment") && WoW.LastSpell == ("HandOfGuldan") && WoW.LastSpell != ("DemonicEmpowerment") && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
                    ...
                    //Demonic Empowerment
					if(WoW.CanCast("DemonicEmpowerment") && (!empowered || !WoW.PetHasBuff("DemonicEmpowerment")) && WoW.LastSpell != ("DemonicEmpowerment") && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
						WoW.CastSpell("DemonicEmpowerment");
						empowered = true;
						return;
...
*/
					...
					if(WoW.CanCast("TK") && WoW.DreadstalkersCount >= 1 && DreadstalkersRemainingDuration > TwoSecondCast && ((WoW.WildImpsCount >= 1 && !threeimps) || 
					WoW.WildImpsCount >= 2) && ImpsRemainingDuration > TwoSecondCast && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
						WoW.CastSpell("TK");
						return;
					}
            ...
            if (combatRoutine.Type == RotationType.AOE)
            {
                ...
                if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat && !WoW.PlayerIsCasting)
                {
					...
					if(WoW.CanCast("CallDreadstalkers") && !SummonDarkglare && (WoW.CurrentSoulShards >= 2 || WoW.PlayerHasBuff("DemonicCalling")) && !Implosion && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
						WoW.CastSpell("CallDreadstalkers");
						empowered = false;
						DreadstalkersTime.Restart();
...
*/
                    ...
                    //Thal'kiel's Consumption
					if(WoW.CanCast("TK") && ((WoW.DreadstalkersCount >= 1 && DreadstalkersRemainingDuration > TwoSecondCast) || Implosion) && ((WoW.WildImpsCount >= 1 && !threeimps) || 
					WoW.WildImpsCount >= 2) && ImpsRemainingDuration > TwoSecondCast && WoW.IsSpellInRange("Doom") && (!WoW.IsMoving || WoW.PlayerHasBuff("Norgannon")))
					{
						WoW.CastSpell("TK");
						return;
