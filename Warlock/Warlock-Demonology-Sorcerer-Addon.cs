...
{
    public class WarlockDemonologyS : CombatRoutine
    {
        ...
        public override void Pulse() // Updated for Legion (tested and working for single target)
        {
            ...
            //Dark Pact
            if (WoW.CanCast("Dark Pact") && CharInfo.T5 == 3 && WoW.HealthPercent <= 30 && !WoW.PlayerHasBuff("Mount"))
            {
            ...
            //Shadowfury
            if (DetectKeyPress.GetKeyState(DetectKeyPress.Alt) < 0 && CharInfo.T3 == 3 && !WoW.IsMoving && WoW.CanCast("Shadowfury"))
            {
            ...
            if (UseCooldowns)
            {
                ...
                {
                    //Doomguard
                    if (WoW.CanCast("Doomguard") && (CharInfo.T6 == 0 || CharInfo.T6 == 2 || CharInfo.T6 == 3) && WoW.CurrentSoulShards >= 1 && WoW.IsSpellInRange("Doom"))
                    {
                    ...
                    //Grimoire of Service
                    if (WoW.CanCast("Grimoire: Felguard") && CharInfo.T6 == 2 && WoW.CurrentSoulShards >= 1 && WoW.IsSpellInRange("Doom"))
                    {
                    ...
                    //Soul Harvest
                    if (WoW.CanCast("Soul Harvest") && CharInfo.T4 == 3 && !WoW.IsMoving && WoW.IsSpellInRange("Doom") &&
            ...
            if (combatRoutine.Type == RotationType.SingleTarget) // Do Single Target Stuff here
            {
                if (WoW.HasTarget && WoW.TargetIsEnemy && !WoW.PlayerIsChanneling && WoW.IsInCombat && !WoW.PlayerIsCasting && !WoW.PlayerHasBuff("Mount"))
                {
                    ...
                    if (WoW.CanCast("Darkglare") && CharInfo.T7 == 1 && WoW.CurrentSoulShards >= 1 && WoW.IsSpellInRange("Doom"))
                    {
                    ...
                    if (WoW.CanCast("Shadowflame") && CharInfo.T1 == 2 && !WoW.TargetHasDebuff("Shadowflame") && WoW.CanCast("Shadowflame") && WoW.IsSpellInRange("Doom"))
                    {
            ...
            if (combatRoutine.Type == RotationType.AOE)
            {
                if (WoW.HasTarget && WoW.TargetIsEnemy && !WoW.PlayerIsChanneling && WoW.IsInCombat && !WoW.PlayerIsCasting && !WoW.PlayerHasBuff("Mount"))
                {
                    ...
                    if (WoW.CanCast("Implosion") && CharInfo.T2 == 3 && WoW.WildImpsCount >= 1 && WoW.IsSpellInRange("Doom"))
                    {
        ...
        private void AddonEmbedEdit()
        {
            try
            {
                var addonlua = File.ReadAllText("" + WoW.AddonPath + "\\" + AddonName + "\\" + AddonEmbedName);
                Log.Write("Addon emedding Editing in progress");
                addonlua = addonlua.Replace("</Ui>",
                    "<Script file=\"lib\\LibSpellRange-1.0\\LibSpellRange-1.0.lua\"/>" + Environment.NewLine + "<Script file = \"lib\\LibSpellRange-1.0\\LibSpellRange-1.0.xml\" />" +
        ...
        private void AddonEdit()
        {
            try
            {
                ...
                addonlua = addonlua.Replace("local lastCombat = nil" + Environment.NewLine + "local alphaColor = 1",
                    "local lastCombat = nil" + Environment.NewLine + "local alphaColor = 1" + Environment.NewLine + CustomLua);
